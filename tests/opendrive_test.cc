...
TEST_F(TestOpenDrive, TestParseRoad) {
  ...
  // ASSERT_DOUBLE_EQ(0.0000000000000000e+00, geometry_info1->s0);
  // ASSERT_DOUBLE_EQ(1.5601319999999987e+02, geometry_info1->x0);
  // ASSERT_DOUBLE_EQ(1.1999995231614086e+02, geometry_info1->y0);
  // ASSERT_DOUBLE_EQ(3.1415926535848282e+00, geometry_info1->hdg0);
  // ASSERT_DOUBLE_EQ(5.1604964355176435e+00, geometry_info1->length());
  // ASSERT_EQ(GeometryType::LINE, geometry_info1->type());

  // ASSERT_DOUBLE_EQ(5.1604964355176435e+00, geometry_info2->s0);
  // ASSERT_DOUBLE_EQ(1.5085270356448223e+02, geometry_info2->x0);
  // ASSERT_DOUBLE_EQ(1.1999995231616649e+02, geometry_info2->y0);
  // ASSERT_DOUBLE_EQ(3.1415926535798597e+00, geometry_info2->hdg0);
  ...
  // ASSERT_DOUBLE_EQ(7.2438297688509765e+00, geometry_info3->s0);
  // ASSERT_DOUBLE_EQ(1.4877093951784059e+02, geometry_info3->x0);
  // ASSERT_DOUBLE_EQ(1.2006020151444957e+02, geometry_info3->y0);
  // ASSERT_DOUBLE_EQ(3.0547870980255456e+00, geometry_info3->hdg0);
  ...
  // ASSERT_DOUBLE_EQ(1.8430053456596493e+01, geometry_info4->s0);
  // ASSERT_DOUBLE_EQ(4.9416434943455940e+01, geometry_info4->x0);
  // ASSERT_DOUBLE_EQ(7.9753610549006124e+00, geometry_info4->y0);
  // ASSERT_DOUBLE_EQ(-3.8812339311141031e-02, geometry_info4->hdg0);
  ...
  // ASSERT_DOUBLE_EQ(2.0513386789929825e+01, geometry_info5->s0);
  // ASSERT_DOUBLE_EQ(1.3860498286986785e+02, geometry_info5->x0);
  // ASSERT_DOUBLE_EQ(1.2755802030419328e+02, geometry_info5->y0);
  // ASSERT_DOUBLE_EQ(2.0357962351612984e+00, geometry_info5->hdg0);
