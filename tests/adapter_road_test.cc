...
TEST_F(TestAdapterRoad, TestAdapterRoad) {
  ...
  ASSERT_EQ("1", section_0->lanes.front()->successors.front());
  ASSERT_EQ("1_0_2", section_0->lanes.at(1)->id);
  ASSERT_EQ("2", section_0->lanes.at(1)->successors.front());
  ASSERT_EQ("1_0_3", section_0->lanes.at(2)->id);
  ASSERT_EQ("3", section_0->lanes.at(2)->successors.front());
  ASSERT_EQ("1_0_-1", section_0->lanes.at(3)->id);
  ASSERT_EQ("-1", section_0->lanes.at(3)->successors.front());
  ASSERT_EQ("1_0_-2", section_0->lanes.at(4)->id);
  ASSERT_EQ("-3", section_0->lanes.at(4)->successors.front());
