...
class UtilAdapter {
 public:
  ...
  virtual void Init() = 0;
  virtual void CalcLinePoint(double& out_x, double& out_y, double start_x,
                             double start_y, double hdg, double length,
                             double distance) final;
  virtual void CalcArcPoint(double& out_x, double& out_y, double& out_hdg,
                            double start_x, double start_y, double hdg,
                            double length, double curvature,
                            double distance) final;
  virtual void CalcSpiralPoint(double& out_x, double& out_y, double& out_hdg,
                               double start_x, double start_y, double hdg,
                               double length, double curve_start,
                               double curve_end, double distance) final;
  virtual void CalcPoly3Point(double& out_x, double& out_y, double s,
                              double start_x, double start_y, double hdg,
                              double length, double a, double b, double c,
                              double d, double distance) final;
  virtual void CalcParamPoly3Point(double& out_x, double& out_y, double s,
                                   double start_x, double start_y, double hdg,
                                   double length, double au, double bu,
                                   double cu, double du, double av, double bv,
                                   double cv, double dv, double distance) final;
